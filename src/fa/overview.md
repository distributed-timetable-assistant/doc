...
1.  **تعریف:** یک موسسه نیازمندی‌های خود (دروس، معلمان، اتاق‌ها) را تعریف می‌کند و آنها را در یک **بسته موسسه** دسته‌بندی می‌کند.
2.  **ارسال:** بسته به شبکه DiTA ارسال می‌شود.
3.  **کشف:** **سرویس‌های حل‌کننده** مستقل بسته را کشف و پیچیدگی آن را تحلیل می‌کنند.
4.  **حل کردن:** حل‌کنندگان جداول زمانی پیشنهادی را با بهینه‌سازی برای محدودیت‌ها و ترجیحات تولید می‌کنند.
5.  **ارزیابی:** سیستم پیشنهادات را بر اساس کیفیت، عدالت و رعایت قوانین امتیازدهی می‌کند.
6.  **انتخاب:** موسسه بهترین راه‌حل را انتخاب می‌کند و حل‌کننده برنده پاداش می‌گیرد.
